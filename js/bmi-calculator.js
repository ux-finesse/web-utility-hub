    document.addEventListener("DOMContentLoaded", () => {
      ...
      function calculateBMI() {
        ...
        if (bmi < 18.5) {
          ...
          message = "You are in the underweight range. Consider consulting with a healthcare professional.";
          color = "#0D6AAD"; 
        } else if (bmi < 25) {
          category = "Normal";
          ...
          category = "Overweight";
          message = "You are in the overweight range. Consider adopting a healthier lifestyle.";
          color = "#F7DF1E"; 
        } else {
          category = "Obese";
          message = "You are in the obese range. Consider consulting with a healthcare professional.";
          color = "#E44D26"; 
        }
      ...
      function resetResults() {
        ...
        bmiMessage.textContent = "Enter your weight and height to calculate your BMI.";
      }
    });
